...
public class BluetoothDeviceListItemAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view = View.inflate(mContext, R.layout.dialog_devices_layout, null);
        ((TextView) view.findViewById(R.id.tv_device_name)).setText(mNames[position]);
        if (mShowAddress)
            ((TextView) view.findViewById(R.id.tv_device_address)).setText(mAddresses[position]);
        return view;
    }
